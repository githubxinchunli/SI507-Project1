...
class TestFetchItunsJson(unittest.TestCase):
    ...
    def testConstructor(self):
        medias1 = proj1.Fetch_Itunes_Json()
        medias2 = proj1.Fetch_Itunes_Json(query="Hey+Jude",number=10)
